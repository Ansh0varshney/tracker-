...
async function handler(req, res) {
    ...
    try {
        ...
        const events = await _models_EmailEvent__WEBPACK_IMPORTED_MODULE_1__/* ["default"].find */ .Z.find().sort({
            timestamp: -1
        });
...
var __webpack_exports__ = __webpack_require__.X(0, [722], () => (__webpack_exec__(102)));
